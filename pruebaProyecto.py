...
doble= 430
individual= 280
ingredientes= [['ja', 'Jamón', 40], ['ch', 'Champiñón', 35], ['pi', "Pimentón", 30], ['dq', "Doble queso", 40], ['ac', "Aceitunas", 57.5], ['pp', 'Pepperoni', 38.5], ['sa', 'Salchichón', 62.5]]
...
while val==1:                     #ciclo para cada sandwich
    ...
    if not listin:
        ...
        i=0
        while i < len(listin):                  #ciclo para imprimir nombre de los ingredientes y sumar su valor a la cuenta
            aux=0
            cont=0
